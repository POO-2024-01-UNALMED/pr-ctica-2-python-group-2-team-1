...
class AplicarBeca(Frame):
    def __init__(self, ventana):
        ...
        titulo = Label(self, text="Aplicar Beca a Estudiante", bg="#F5F5DC", fg="#8B4513", font=("Helvetica", 14, "bold"))
        ...
        descripcion = Label(self, text=textoDesc, bg="#F5F5DC", font=("Arial", 10), fg="#110433")
        descripcion.pack(anchor="n", pady=20)

        aplicandoFrame = Frame(self, bg="#F5F5DC")
        aplicandoFrame.pack()

        becaTit = Label(aplicandoFrame, text="Becas existentes", bg="#F5F5DC", font=("Arial", 11, "bold"), fg="#8B4513")
        becaTit.grid(row=0, column=0, padx=10, pady=10)
        estTit = Label(aplicandoFrame, text="Estudiantes matriculados", bg="#F5F5DC", font=("Arial", 11, "bold"), fg="#8B4513")
        ...
        boton = Button(self, text="Aplicar Beca", command=asigBeca, font=("Arial", 11, "bold"), fg="white", bg="#8B4513")
        boton.pack()
