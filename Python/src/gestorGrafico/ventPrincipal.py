...
¡Esperamos que disfrutes de nuestra aplicación y tengas un exitoso período académico!
        ...
        def mostrarAutores():
            autores = (
                "Autores de la aplicacion:/n/n"
                + "Juan Diego Sanchez/n/n"
                + "Juan Miguel Ochoa/n/n"
                + "David Posada Salazar/n/n"
                + "Daniel Hernando Zambrano/n/n"
                + "Sebastian Martinez Sequeira"
            )
        ...
        frame = Frame(self, bg="#E7D3B1")
        frame.pack(anchor="center",expand=True)
#"#FAF3E0"
        bienvenida_label = Label(frame, text="¡Bienvenido a la ventana principal de UniAdmin!", font=("Arial", ), fg="#8B4513", bg="#FAF3E0")
    ...
    " /_/   \\_\\   \n"
        ...
        info_text = Label(frame, text=informacion, font=("Arial", 10), fg="#8B4513",bg="#FAF3E0")
