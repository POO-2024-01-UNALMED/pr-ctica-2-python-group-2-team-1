...
class DesmatricularAlumno(Frame):
    def __init__(self,ventana):
        ...
        self.config(highlightbackground="#8B5A2B",highlightthickness=3, bg="#FAEBD7")
        ...
        titulo = Label(self, text="Desmatricular Alumno", font=("Arial", 14), fg="#5D3A00", bg="#FAEBD7")
        ...
        descripcion = Button(self, text=textDescripcion, font=("Arial", 10), fg="#5D3A00", bg="#DEB887")
        descripcion.pack(anchor="n", pady=20)

        frame = Frame(self, bg="#FAEBD7")
        frame.pack(padx=5, pady=5)

        nombre = Label(frame, text="Elija como quiere seleccionar el alumno", font=("Arial", 14), fg="#5D3A00", bg="#FAEBD7")
        nombre.pack(side="top", anchor="n", pady=20)

        opcion1 = Button(frame, text="Ver la lista de estudiantes", font=("Arial", 10), fg="#5D3A00", bg="#DEB887", command=listaEstudiantes)
        opcion1.pack(side="left", pady=20, padx=10)

        opcion2 = Button(frame, text="Buscar estudiante por ID (Documento) y nombre", font=("Arial", 10), fg="#5D3A00", bg="#DEB887", command=buscarEstudiante)
...
class AlumnoPorLista(Frame):
    def __init__(self,ventana):
        ...
        def seleccionMateria(event):
                ...
                self._materiaSeleccionada = Label(der, text=infoMateria, font=("Arial", 10),bg="#FAEBD7")
        ...
        def desmatricularMateria():
            ...
            titulo2 = Label(der, text="Desmatricular de Materia", font=("Arial", 14), bg="#FAEBD7")
            ...
            botonDesmatricular = Button(der, text="Desmatricular", font=("Arial", 10), command=desmatricularGrupo, bg="#DEB887", fg="#5D3A00")
        ...
        izq=Frame(ventana, height=460,width=250, bg="#FAEBD7")
        izq.pack(side="left", anchor="e")
        izq.pack_propagate(False)

        atras = Button(izq, text="Atras", font=("Arial", 10), bg="#DEB887", fg="#5D3A00", command=retroceder)
        atras.pack(side="bottom", anchor="center", padx=10, pady=10)

        desc = Label(izq, text="Elija al estudiante", font=("Arial", 14), bg="#FAEBD7")
        ...
        combo.pack(fill="x", pady=10, padx=10)

        der=Frame(ventana, height=460,width=615, bg="#FAEBD7")
        der.pack(side="right", fill="both")
        der.pack_propagate(False)

        subFrame = Frame(der, highlightbackground="#8B5A2B", highlightthickness=3, bg="#FAEBD7")
        subFrame.pack(padx=5, pady=5, expand=True)

        titulo = Label(subFrame, text="Desmatricular Alumno", font=("Arial", 14), fg="#5D3A00", bg="#FAEBD7")
        titulo.pack(side="top", anchor="center", pady=10, padx=5)

        text = "Seleccione de que quiere desmatricular al estudiante"

        descripcion = Label(subFrame, text=text, font=("Arial", 10), fg="#5D3A00", bg="#FAEBD7")
        descripcion.pack(pady=10, padx=5)

        desmatricular1 = Button(subFrame, text="Desmatricular del sistema", font=("Arial", 10), fg="#5D3A00", bg="#DEB887", command=desmatricularDelSistema)
        desmatricular1.pack(pady=20, padx=5)

        desmatricular2 = Button(subFrame, text="Desmatricular de una materia", font=("Arial", 10), fg="#5D3A00", bg="#DEB887", command=desmatricularMateria)
...
class AlumnoPorBusqueda(Frame):
    ...
    def __init__(self,ventana):
        ...
        def desmatricularMateria():
            ...
            titulo2 = Label(der, text="Desmatricular de Materia", font=("Arial", 14), fg="#5D3A00", bg="#FAEBD7")
            titulo2.pack(side="top", anchor="center", padx=10, pady=10)
            ...
            botonDesmatricular = Button(der, text="Desmatricular", font=("Arial", 10), fg="#5D3A00", bg="#DEB887", command=desmatricularGrupo)
            botonDesmatricular.pack(side="bottom", anchor="center", pady=10)
        ...
        der=Frame(ventana, height=460,width=615, bg="#DEB887")
        der.pack(side="right", fill="both")
        der.pack_propagate(False)

        criterios = ["Nombre", "Documento"]
        fildEstudiante = FieldFrame(izq, "Criterio", criterios, "Valor", bg="#FAEBD7")

        fildEstudiante.pack()

        frame = Frame(izq,bg="#FAEBD7")
        frame.pack(fill="x")

        acept = Button(frame, text="Buscar", font=("Arial", 10), fg="#5D3A00", bg="#DEB887", command=buscarEstudiante)
        acept.pack(side="left", anchor="ne", padx=10, pady=10)

        borrar = Button(frame, text="Borrar", font=("Arial", 10), fg="#5D3A00", bg="#DEB887", command=limpiar)
