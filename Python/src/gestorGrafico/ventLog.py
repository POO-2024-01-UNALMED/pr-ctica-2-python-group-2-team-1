...
class VentLog(Tk):
    def __init__(self):
        ...
        self.config(bg="#F5E6C4",highlightbackground="#8B5A2B",highlightthickness=5)
        self.iconbitmap("Python/src/gestorGrafico/Imagenes/icono.png")

        frame = Frame(self, width=400, height=200,bg="#F5E6C4",highlightbackground="#8B5A2B",highlightthickness=5)
        ...
        usuar = Label(frame,text="Usuario",bg="#F5E6C4",font=("arial", 11, "bold"),fg="#6D4C41")
        entrada1 = Entry(frame)
        cont = Label(frame,text="Contraseña",bg="#F5E6C4",font=("arial", 11, "bold"),fg="#6D4C41")
        entrada2 = Entry(frame, show="*")
        boton_ingresar = Button(frame, text="Iniciar Sesion", command= verificar,bg="#8B5A2B",font=("arial", 11, "bold"),fg="#F5E6C4")
        boton_limpiar = Button(frame, text="Limpiar", command= limpiar,bg="#8B5A2B",font=("arial", 11, "bold"),fg="#F5E6C4")
        revisar = Checkbutton(frame, text="Mostrar contraseña", command= mostrarContraseña,bg="#F5E6C4",font=("arial", 11),fg="#6D4C41")        
