...
class CrearBeca(Frame):
    def __init__(self, ventana):
        ...
        titulo = Label(self, text="Crear Beca", bg="#F5F5DC", foreground="#8B4513", font=("Helvetica", 14, "bold"))
        ...
        descripcion = Label(self, text=texto, font=("Arial", 11), bg="#F5F5DC")
        descripcion.pack(anchor="n")

        creandoBeca = Frame(self, bg="#F5F5DC")
        creandoBeca.pack()
        
        crit = Label(creandoBeca, text="Criterios", font=("Arial", 11, "bold"), fg="#8B4513", bg="#F5F5DC")
        crit.grid(row=0, column=0, padx=10, pady=10)

        val = Label(creandoBeca, text="Valores", font=("Arial", 11, "bold"), fg="#8B4513", bg="#F5F5DC")
        val.grid(row=0, column=1, padx=10, pady=5)

        cuposL = Label(creandoBeca, text="Cupos", font=("Arial", 11), fg="#8B4513", bg="#F5F5DC")
        cuposL.grid(row=1, column=0, padx=10, pady=5)
        cuposE = Entry(creandoBeca, font=("Arial", 11))
        cuposE.grid(row=1, column=1, padx=10, pady=5)
        
        nombreL = Label(creandoBeca, text="Nombre", font=("Arial", 11), fg="#8B4513", bg="#F5F5DC")
        ...
        promedioL = Label(creandoBeca, text="Promedio requerido", font=("Arial", 11), fg="#8B4513", bg="#F5F5DC")
        ...
        avanceL = Label(creandoBeca, text="Avance requerido", font=("Arial", 11), fg="#8B4513", bg="#F5F5DC")
        ...
        estratoL = Label(creandoBeca, text="Estrato máximo\n para aplicar", font=("Arial", 11), fg="#8B4513", bg="#F5F5DC")
