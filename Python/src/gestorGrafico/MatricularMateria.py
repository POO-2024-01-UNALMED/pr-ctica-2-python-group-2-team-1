...
class MatricularMateria(Frame):
    def __init__(self, ventana):
        ...
        self.config(highlightbackground="#5D3A00", background="#FAEBD7",highlightthickness=3)

        titulo = Label(self, text="Matricular Materia", foreground="#5D3A00",background="#FAEBD7",font=("Helvetica", 14, "bold"))
...
2. Búsqueda por lista: Selecciona un estudiante de una lista disponible."""
        descripcion = Label(self, text=texto,foreground="#5D3A00", background="#FAEBD7", font=("Arial", 11))
        descripcion.pack(anchor="n", pady=10)
        opciones = Frame(self,background="#8B4513")
        opciones.pack()
        manual = Button(opciones, text="Seleccionar al estudiante\n de forma manual", 
                foreground="#5D3A00", background="#8B4513", 
                activebackground="#8B4513", highlightbackground="#5D3A00", 
                font=("Helvetica", 12), 
                command=lambda: self.seleccionar_estudiante(caja, label_vacio, False))

        lista = Button(opciones, text="Seleccionar al estudiante\n mediante una lista", 
               foreground="#5D3A00", background="#8B4513", 
               activebackground="#8B4513", highlightbackground="#5D3A00", 
               font=("Helvetica", 12), 
               command=lambda: self.seleccionar_estudiante(caja, label_vacio, True))
        ...
        busqueda = Frame(self)
        busqueda.pack()
        label_vacio = Label(busqueda, text="",font=("Arial", 11),background="#FAEBD7")
        label_vacio.pack(pady=(10, 10))
        caja = Frame(self, background="#FAEBD7")
        caja.pack()
    ...
    def seleccionar_estudiante(self, frame, label, busqueda_lista=False):
        ...
        if busqueda_lista:
            label.config(text="Entro a busqueda por lista",bg="#FAEBD7")
            nombres_texto = ""
            ...
            lista = Text(frame, border=True, font=("Arial", 11),bg="#FAEBD7",highlightbackground="#5D3A00",highlightthickness=3)
            lista.pack()
            lista.configure(height=5, )
            self.mostrar_texto(nombres_texto, lista)
            self.campo = FieldFrame(frame, "Criterio", ["Numero"], "Valor",)
            self.campo.config(bg="#D2B48C")
            ...
            self.campo2 = FieldFrame(frame, "Criterio", ["Nombre", "ID"], "Valor",bg="#FAEBD7")
            self.campo2.config(bg="#D2B48C")
...
class MatricularMateria2(Frame):
    def __init__(self, ventana, estudiante):
        ...
        self.pack(expand=True)
        self.config(highlightbackground="#FAEBD7",highlightthickness=3, bg="#FAEBD7")
        titulo = Label(self, text="Matricular Materia 2", foreground="#5D3A00",background="#FAEBD7",font=("Helvetica", 14, "bold"))
        titulo.pack(side="top", anchor="c")
...
2. Búsqueda por lista: Selecciona una materia de una lista disponible."""
        ...
        seleccion=Label(self, text=seleccionados, font=("Arial", 11,"bold"),background="#FAEBD7")
        seleccion.pack(anchor="n", pady=5)
        descripcion = Label(self, text=texto,background="#FAEBD7", font=("Arial", 11))
        descripcion.pack(anchor="n", pady=5)
        opciones = Frame(self)
        opciones.pack()
        manual = Button(opciones,text="Seleccionar la materia\n de forma manual",foreground="white",background="#8B4513",font=("Helvetica", 12),command=lambda: self.seleccionar_materia(caja, label_vacio, False))
        lista = Button(opciones,text="Seleccionar la materia\n mediante una lista",foreground="white",background="#8B4513",font=("Helvetica", 12),command=lambda: self.seleccionar_materia(caja, label_vacio, True))
        manual.pack(side=LEFT, padx=(0, 10))
        lista.pack(side=LEFT, padx=(10, 10))
        busqueda = Frame(self)
        busqueda.pack()
    ...
    def seleccionar_materia(self, ventana, label, busqueda_lista=False):
        ...
        if busqueda_lista:
            ...
            lista = Text(ventana, border=True, font=("Arial", 11),bg="#FAEBD7",highlightbackground="#5D3A00",highlightthickness=3)
            lista.pack()
            lista.configure(height=5)
            if (materias_texto==""):
...
class MatricularMateria3(Frame):
    def __init__(self, ventana, estudiante, materia):
        ...
        self.pack(expand=True)
        self.config(highlightbackground="#5D3A00",highlightthickness=3,background="#FAEBD7")

        titulo = Label(self, text="Matricular Materia 3", foreground="#5D3A00",font=("Helvetica", 14, "bold"),background="#FAEBD7") 
        titulo.pack(side="top", anchor="c")
        ...
        seleccion=Label(self, text=seleccionados, font=("Arial", 11,"bold"),background="#FAEBD7")
        seleccion.pack(anchor="n", pady=5)
        descripcion = Label(self, text=texto, font=("Arial", 11),bg="#FAEBD7")
        descripcion.pack(anchor="n", pady=5)
        caja = Frame(self,bg="#FAEBD7")
        caja.pack()
        ...
        lista = Text(caja, border=True, font=("Arial", 11),bg="#FAEBD7",highlightbackground="#5D3A00",highlightthickness=3) 
        lista.pack()
...
class MatricularMateria4(Frame):
    def __init__(self, ventana, estudiante):
        ...
        self.estudiante=estudiante
        self.pack(expand=True)
        self.config(highlightbackground="#5D3A00",highlightthickness=3,bg="#FAEBD7")

        titulo = Label(self, text="Mostrar horario estudiante", foreground="#5D3A00",font=("Helvetica", 14, "bold"),bg="#FAEBD7")
        titulo.pack(side="top", anchor="c")
        seleccionado="Estudiante seleccionado: "+self.estudiante.getNombre()
        seleccion=Label(self, text=seleccionado, font=("Arial", 11,"bold"),bg="#FAEBD7")
